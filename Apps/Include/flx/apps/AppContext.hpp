 ...
 */
using ResultCallback = std::function<void(ResultCode resultCode, const flx::core::Bundle& data)>;
...
public:
	...
	void setResult(ResultCode code, const flx::core::Bundle& data = {}) {
		m_resultCode = code;
		m_resultData = data;
		m_hasResult = true;
	}
	...
	const flx::core::Bundle& getResultData() const { return m_resultData; }
