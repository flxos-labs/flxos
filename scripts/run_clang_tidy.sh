...
done < <(find "$PROJECT_ROOT/main" "$PROJECT_ROOT/System" "$PROJECT_ROOT/UI" "$PROJECT_ROOT/Connectivity" "$PROJECT_ROOT/Kernel" "$PROJECT_ROOT/Services" "$PROJECT_ROOT/Core" -name "*.cpp" -print0)
