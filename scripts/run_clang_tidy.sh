...
done < <(find "$PROJECT_ROOT/System" "$PROJECT_ROOT/UI" "$PROJECT_ROOT/Connectivity" "$PROJECT_ROOT/Kernel" "$PROJECT_ROOT/Services" "$PROJECT_ROOT/Core" "$PROJECT_ROOT/Apps" "$PROJECT_ROOT/Applications" "$PROJECT_ROOT/Firmware" "$PROJECT_ROOT/HalModule" "$PROJECT_ROOT/Profiles" -name "*.cpp" -print0)
